        ...
        rs.register(Rule.new(
                      ...
                      check: ->(doc) {
                        ...
                        Violation.new(rule_id: "a1-3",
                                      message: "PDF/A-1 requires version <= 1.4, got #{doc.version}",
        ...
        rs.register(Rule.new(
                      ...
                      check: ->(doc) {
                        ...
                        Violation.new(rule_id: "a2-3",
                                      message: "PDF/A-2 does not allow PDF 2.0, got #{doc.version}",
        ...
        rs.register(Rule.new(
                      ...
                      check: ->(doc) {
                        ...
                        Violation.new(rule_id: "a4-1",
                                      message: "PDF/A-4 requires PDF 2.0, got #{doc.version}",
        ...
        rs.register(Rule.new(
                      ...
                      check: ->(doc) {
                        ...
                        doc.each_indirect_object do |annot|
                          ...
                          r = annot.value[:Rect]
                          next if r.is_a?(::Array) && r.length == 4 && r[0] == r[2] && r[1] == r[3]
