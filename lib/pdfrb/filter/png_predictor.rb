...
module Pdfrb
  module Filter
    # PNG predictor (s7.4.8.4 / RFC 2083 6.6). Shared by FlateDecode
    # and LZWDecode — both can receive a /Predictor 10..15 parameter
    # requiring the same row-level unfilter.
    module PngPredictor
      class << self
